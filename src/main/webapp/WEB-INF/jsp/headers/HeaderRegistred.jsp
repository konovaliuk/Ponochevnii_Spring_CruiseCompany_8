...
<div class="header-form">
    ...
    <div class="header-button-div">
        <form style="float: right" method="get" action="${ActionStorage.LOGOUT}">
            <input type="submit" value="<fmt:message key="message.headerregistred.logout"/>"/>
        </form>
    </div>

    <div class="header-button-div">
        <form style="float: right" method="get" action="${ActionStorage.MY_ACCOUNT}">
            <input type="submit" value="<fmt:message key="message.headerregistred.myaccount"/>"/>
        </form>
    </div>

    <div class="header-button-div">
        <form style="float: right" method="get" action="${ActionStorage.VIEW_MY_CART}">
            <input type="submit" value="<fmt:message key="message.headerregistred.mycart"/>"/>
        </form>
    </div>

    <div class="header-button-div">
        <form style="float: right" method="get" action="${ActionStorage.VIEW_MY_CRUISES}">
